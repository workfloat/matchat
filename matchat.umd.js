(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("MatChat", [], factory);
	else if(typeof exports === 'object')
		exports["MatChat"] = factory();
	else
		root["MatChat"] = factory();
})(this, () => {
...
class MatChat {
    constructor(options = {}) {
        ...
        this.boundHandlers = {
            ...
            inputKeyPress: (e) => this.handleInputKeyPress(e),
        ...
        this.options = this.validateOptions(Object.assign(Object.assign({}, this.defaultOptions), options));
    ...
    `;
        ...
        this.chatMessages = this.chatPopup.querySelector('.chat-messages');
        this.chatInput = this.chatPopup.querySelector('.chat-input');
        this.sendButton = this.chatPopup.querySelector('.send-button');
        this.chatClose = this.chatPopup.querySelector('.chat-close');
    }
    applyCustomStyles() {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x;
        const root = document.documentElement;
        const setStyle = (prop, value) => value && root.style.setProperty(`--matchat-${prop}`, value);
        ...
        setStyle('primary-color', (_a = this.options.colors) === null || _a === void 0 ? void 0 : _a.primary);
        setStyle('primary-dark', (_b = this.options.colors) === null || _b === void 0 ? void 0 : _b.primaryDark);
        setStyle('secondary-color', (_c = this.options.colors) === null || _c === void 0 ? void 0 : _c.secondary);
        setStyle('text-color', (_d = this.options.colors) === null || _d === void 0 ? void 0 : _d.text);
        setStyle('light-text', (_e = this.options.colors) === null || _e === void 0 ? void 0 : _e.lightText);
        setStyle('white', (_f = this.options.colors) === null || _f === void 0 ? void 0 : _f.white);
        setStyle('background-image', this.options.backgroundImage);
        setStyle('background-pattern', this.options.backgroundPattern);
        setStyle('width', (_g = this.options.dimensions) === null || _g === void 0 ? void 0 : _g.width);
        setStyle('height', (_h = this.options.dimensions) === null || _h === void 0 ? void 0 : _h.height);
        setStyle('avatar-size', (_j = this.options.dimensions) === null || _j === void 0 ? void 0 : _j.avatarSize);
        setStyle('message-max-width', (_k = this.options.dimensions) === null || _k === void 0 ? void 0 : _k.messageMaxWidth);
        setStyle('bot-message-border-radius', (_m = (_l = this.options.messageBubbleStyle) === null || _l === void 0 ? void 0 : _l.bot) === null || _m === void 0 ? void 0 : _m.borderRadius);
        setStyle('user-message-border-radius', (_p = (_o = this.options.messageBubbleStyle) === null || _o === void 0 ? void 0 : _o.user) === null || _p === void 0 ? void 0 : _p.borderRadius);
        setStyle('bot-message-min-width', (_r = (_q = this.options.messageBubbleStyle) === null || _q === void 0 ? void 0 : _q.bot) === null || _r === void 0 ? void 0 : _r.minWidth);
        setStyle('user-message-min-width', (_t = (_s = this.options.messageBubbleStyle) === null || _s === void 0 ? void 0 : _s.user) === null || _t === void 0 ? void 0 : _t.minWidth);
        setStyle('bot-message-padding', (_v = (_u = this.options.messageBubbleStyle) === null || _u === void 0 ? void 0 : _u.bot) === null || _v === void 0 ? void 0 : _v.padding);
        setStyle('user-message-padding', (_x = (_w = this.options.messageBubbleStyle) === null || _w === void 0 ? void 0 : _w.user) === null || _x === void 0 ? void 0 : _x.padding);
    ...
    getIsOpen() {
        var _a, _b;
        return (_b = (_a = this.chatPopup) === null || _a === void 0 ? void 0 : _a.classList.contains('active')) !== null && _b !== void 0 ? _b : this.isOpen;
    }
    ...
    sendToBackend(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isDestroyed)
                return;
            try {
                const response = yield fetch(this.options.apiUrl, {
                    method: ((_a = this.options.webhookConfig) === null || _a === void 0 ? void 0 : _a.method) || 'POST',
                    headers: Object.assign({ 'Content-Type': 'application/json' }, (((_b = this.options.webhookConfig) === null || _b === void 0 ? void 0 : _b.headers) || {})),
                    body: JSON.stringify({
                        message,
    ...
    addMessage(text, sender) {
        if (this.isDestroyed || !this.chatMessages)
            return;
        try {
    ...
    updateCharacterCount() {
        var _a;
        const existingCounter = (_a = this.chatInput.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.character-counter');
        if (existingCounter)
    ...
    destroy() {
        ...
        try {
            (_a = this.chatButton) === null || _a === void 0 ? void 0 : _a.removeEventListener('click', this.boundHandlers.chatButtonClick);
            (_b = this.chatClose) === null || _b === void 0 ? void 0 : _b.removeEventListener('click', this.boundHandlers.chatCloseClick);
            (_c = this.sendButton) === null || _c === void 0 ? void 0 : _c.removeEventListener('click', this.boundHandlers.sendMessageClick);
            (_d = this.chatInput) === null || _d === void 0 ? void 0 : _d.removeEventListener('keypress', this.boundHandlers.inputKeyPress);
            (_e = this.chatInput) === null || _e === void 0 ? void 0 : _e.removeEventListener('input', this.boundHandlers.inputChange);
            this.boundHandlers = {};
            if ((_f = this.container) === null || _f === void 0 ? void 0 : _f.parentNode) {
...
if (typeof window !== 'undefined') {
    window.MatChat = MatChat;
}
/* harmony default export */ const src = (MatChat);
